export const betRegistryAbi = [
    ...
    "outputs": [
      {
        ...
        "components": [
          ...
          { "name": "endTime", "type": "uint40", "internalType": "uint40" },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum IBetRegistry.MarketStatus"
          },
          {
            "name": "targetPrice",
            "type": "uint256",
  ...
  },
  {
    ...
    "name": "setSlashPeriod",
    "inputs": [
      { "name": "slashPeriod_", "type": "uint256", "internalType": "uint256" }
    ],
    "outputs": [],
    "stateMutability": "nonpayable"
  },
...
export const betRegistryAddress = "0x55a332d75f2BC9937d50084b8D4af7cB9Fa192Fe";
