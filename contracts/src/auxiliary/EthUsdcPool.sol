...
contract EthUsdcPool {
    ...
    function togglePrice() external {
        tickCumulatives[0] = -3877699926748;
        tickCumulatives[1] = -3877711536046;

        secondsPerLiquidityCumulativeX128s[0] = 40986729906736644676633363845;
        secondsPerLiquidityCumulativeX128s[1] = 40986754765085421655622951391;
    }
}
